node {
    ...
    stage ('deploy') {
        ...
        sh 'sudo rsync -avrt --delete --rsh="ssh -p 22" ./ root@172.31.42.196:Stock\\ Service\\ Pipeline'
        sh 'sudo rsync -avrt --delete --rsh="ssh -p 22" ./ root@172.31.39.151:Stock\\ Service\\ Pipeline'

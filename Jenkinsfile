node {
    ...
    stage ('deploy') {
        ...
        sh 'sudo rsync -avrt --delete --rsh="ssh -p 22" "/var/lib/jenkins/workspace/Stock Service Pipeline" root@172.31.42.196:"/var/lib/jenkins/workspace/Stock Service Pipeline"'
        sh 'sudo rsync -avrt --delete --rsh="ssh -p 22" "/var/lib/jenkins/workspace/Stock Service Pipeline" root@172.31.39.151:"/var/lib/jenkins/workspace/Stock Service Pipeline"'
